...
sort ID
xtset ID YEAR
**il y a des entreprises qui ont des variables ayant des données manquantes d'0u le terme "unbalanced"
*1er model
...
xtreg ESCORE ROA ROE LEVERAGE GSCORE ISO14000_EMS ROAD_RAIL MARINE YEAR19_20 COVID_MARINE COVID_ROAD_RAIL, vce (cluster ID)
outreg2 using perfomance_environmental, replace excel dec (3)
*xtreg SSCORE SIZE  LEVERAGE SDG8 ROAD_RAIL MARINE GSCORE YEAR19_20 YEAR21 , fe
*estimates store fixed
*outreg2 using perfomance_sociale, append excel dec (3)
xtreg ESCORE ROA ROE LEVERAGE GSCORE ISO14000_EMS ROAD_RAIL MARINE YEAR19_20 COVID_MARINE COVID_ROAD_RAIL , re
estimate store random
outreg2 using perfomance_environmental, append excel dec (3)
